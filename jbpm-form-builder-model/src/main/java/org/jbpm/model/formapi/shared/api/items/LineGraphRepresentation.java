...
public class LineGraphRepresentation extends FormItemRepresentation {
    ...
    public void setDataMap(Map<String, Object> data)
        ...
        List<Object> dataStructureMap = (List<Object>) data
                .get("dataStructure");
        if (dataStructureMap != null) {
            ...
            for (Object obj : dataStructureMap) {
                if (obj != null) {
                    ...
                    if (!struc.isEmpty()) {
                        Map.Entry<String, Object> entryMap = struc.entrySet()
                                .iterator().next();
                        entries.put(entryMap.getKey(),
                                String.valueOf(entryMap.getValue()));
                        this.dataStructure.add(entries.entrySet().iterator()
                                .next());
                        entries.clear();
                    }
                }
    ...
    public int hashCode() {
        ...
        result = prime * result
                + ((dataStructure == null) ? 0 : dataStructure.hashCode());
        result = prime * result
                + ((dataTable == null) ? 0 : dataTable.hashCode());
        result = prime * result
                + ((graphTitle == null) ? 0 : graphTitle.hashCode());
        result = prime * result
                + ((graphXTitle == null) ? 0 : graphXTitle.hashCode());
        result = prime * result
                + ((graphYTitle == null) ? 0 : graphYTitle.hashCode());
        return result;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (dataTable == null) {
            ...
            return false;
        if (graphTitle == null) {
            if (other.graphTitle != null)
                return false;
        } else if (!graphTitle.equals(other.graphTitle))
            return false;
        if (graphXTitle == null) {
            if (other.graphXTitle != null)
                return false;
        } else if (!graphXTitle.equals(other.graphXTitle))
            return false;
        if (graphYTitle == null) {
            if (other.graphYTitle != null)
                return false;
        } else if (!graphYTitle.equals(other.graphYTitle))
            return false;
        return true;
    }
