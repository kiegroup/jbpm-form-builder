...
import org.jbpm.model.formapi.shared.api.items.ButtonRepresentation;
...
public class ButtonFormItem extends FBFormItem implements I18NFormItem {
    ...
    public FormItemRepresentation getRepresentation() {
        ButtonRepresentation rep = super.getRepresentation(new ButtonRepresentation());
    ...
    public void populate(FormItemRepresentation rep) throws FormBuilderException {
        if (!(rep instanceof ButtonRepresentation)) {
            throw new FormBuilderException(i18n.RepNotOfType(rep.getClass().getName(), "ButtonRepresentation"));
        }
        super.populate(rep);
        ButtonRepresentation crep = (ButtonRepresentation) rep;
