...
import org.jbpm.model.formbuilder.client.form.items.ServerTransformationFormItem;
...
public class ServerTransformationMenuItem extends FBMenuItem {
    ...
    public Label getDescription() {
        return new Label(CommonGlobals.getInstance().getI18n().MenuItemServerScript());
    }
