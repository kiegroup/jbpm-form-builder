...
import org.jbpm.model.formbuilder.client.form.items.SummaryFormItem;
...
public class SummaryMenuItem extends FBMenuItem {
    ...
    public SummaryMenuItem(List<FBFormEffect> formEffects) {
        super(formEffects);
    }
    
    @Override
    public Label getDescription() {
        return new Label(CommonGlobals.getInstance().getI18n().MenuItemSummary());
    }
